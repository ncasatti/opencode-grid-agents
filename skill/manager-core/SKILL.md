---
name: manager-core
description: Python CLI framework expert - Build interactive command-line tools with fzf menus, auto-discovery, and modular architecture
...
- ✅ Working on manager-core templates (serverless, konfig, basic)
- ✅ Implementing fzf-based selection menus
- ✅ Adding new features to manager-core framework
...
manager init                              # basic template
manager init --template serverless        # serverless template
manager init --template konfig            # konfig template

# Interactive mode (recommended)
manager                                   # Starts fuzzy-searchable menu
...
black manager_core/ tests/ --line-length 100  # Format code
isort manager_core/ tests/ --profile black    # Sort imports
```
...
from manager_core.core.logger import log_success, log_error, log_info
...
**Key Points:**
- `name`: Used for CLI invocation (`manager mycommand`)
...
**CORRECT:**
```python
from manager_core.core.logger import log_info, log_success, log_error
...
Manager-core uses a **tree-based menu system** with fzf for navigation:
...
from manager_core.commands.base import BaseCommand
from manager_core.core.emojis import Emoji
from manager_core.core.logger import log_info, log_section, log_success
...
All emojis are defined in `manager_core.core.emojis.Emoji`:
...
manager init --template serverless        # serverless template
manager init --template konfig            # konfig template
manager init --force                      # overwrite existing
```
...
# Verify installation
python -c "import manager_core; print(manager_core.__file__)"
```
...
- Command file exists
- No errors
- Command doesn't appear in `manager --help`
...
bat manager_core/templates/basic/commands/greet.py
bat manager_core/templates/serverless/commands/functions.py
```
...
```bash
# Interactive mode
manager  # Select "My Command" from menu

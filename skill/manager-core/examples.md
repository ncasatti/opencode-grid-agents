# Manager-Core Complete Examples

This file contains complete, copy-pasteable examples of manager-core commands.
...
```bash
# Interactive mode
manager  # Select "Items" → "Create Item"

# CLI mode
manager items create my-item "my value"
manager items read
manager items read my-item
manager items update my-item "new value"
manager items delete my-item
```
...
```bash
# Interactive mode
manager  # Select "Pipeline" → "Full Pipeline - All Functions"

# CLI mode
manager pipeline                          # Full pipeline (all functions)
manager pipeline --function my-function   # Full pipeline (specific function)
manager pipeline --skip-build             # Skip build step
```
...
from manager_core.commands.base import BaseCommand
from manager_core.core.emojis import Emoji
from manager_core.core.logger import log_error, log_info, log_section, log_success, log_warning
from manager_core.core.menu import MenuNode
...
```bash
# Interactive mode
manager  # Select "Status" → "Full Status"

# CLI mode
manager status
manager status --verbose
```
...
```bash
# Interactive mode
manager  # Select "Calculator" → "Add"

# CLI mode
manager calculator 10 + 5
manager calculator 20 / 4
```
...
from manager_core.commands.base import BaseCommand
from manager_core.core.emojis import Emoji
from manager_core.core.logger import log_error, log_info, log_success
from manager_core.core.menu import MenuNode
...
```bash
# Interactive mode
manager  # Select "Server" → "Start Server"
...
- Run `manager` to test interactive mode
- Run `manager <command>` to test CLI mode
